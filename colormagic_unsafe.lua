...
---@alias colormagic_u.InFormat string | InputStream | Texture

---@type {[string]: fun(in: colormagic_u.InFormat, ...: any): colormagic_u.file_pack}
local loaders = {
    ["string"] = preparse_png,
    ---@param is InputStream
...
---@param input colormagic_u.InFormat
---@param ... any
